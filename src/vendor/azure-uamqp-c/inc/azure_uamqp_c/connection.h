...
extern "C" {
	...
	MOCKABLE_FUNCTION(, int, connection_allocate_link_handle, CONNECTION_HANDLE, connection, handle*, link_handle);
	MOCKABLE_FUNCTION(, int, connection_release_link_handle, CONNECTION_HANDLE, connection, handle, link_handle);
